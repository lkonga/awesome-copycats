...
run_once({ "export GDK_SCALE=2","export GDK_DPI_SCALE=0.6","unclutter -root","xscreensaver -nosplash", "mpd ~/.mpd/mpd.conf","xmodmap ~/.Xmodmap_es","nm-applet","redshift-gtk", "caffeine-indicator"}) -- entries must be comma-separated
-- }}}
...
awful.key({ modkey }, "c", function () os.execute("xsel | xsel -i -b") end,
{description = "copy terminal to gtk", group = "hotkeys"}),
-- awful.key({ modkey }, "c", function () awful.spawn("xsel | xsel -i -b") end,
--           {description = "copy terminal to gtk", group = "hotkeys"}),
-- Copy clipboard to primary (gtk to terminals)
awful.key({ modkey }, "v", function () os.execute("xsel -b | xsel") end,
{description = "copy gtk to terminal", group = "hotkeys"}),
-- awful.key({ modkey }, "v", function () awful.spawn("xsel -b | xsel") end,
--           {description = "copy gtk to terminal", group = "hotkeys"}),

-- xscreensaver
awful.key({ altkey, "Control" }, "l", function () awful.spawn("xscreensaver-command -activate") end,
